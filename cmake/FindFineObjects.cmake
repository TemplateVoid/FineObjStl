...
if(WIN32 AND MSVC)
    set(FINE_LIBRARIES_DIR ${FINE_ROOT}/lib)
elseif(IOS AND XCODE)
    set(FINE_LIBRARIES_DIR ${FINE_ROOT}/X.IOS.${FINE_BUILD_TYPE}/${IOS_ARCH})
else(LINUX OR DARWIN OR ANDROID)
    set(FINE_LIBRARIES_DIR ${FINE_ROOT}/X.${CMAKE_SYSTEM_NAME}.${FINE_BUILD_TYPE}/)
    if(LINUX)
        if(32_BIT)
            string(APPEND FINE_LIBRARIES_DIR "x86")
        else()
            string(APPEND FINE_LIBRARIES_DIR "x86_64")
        endif()
    elseif(DARWIN)
        string(APPEND FINE_LIBRARIES_DIR "x86_64")
    elseif(ANDROID)
        string(APPEND FINE_LIBRARIES_DIR obj/local/${ANDROID_ABI})
    endif()
endif()
...
if(NOT WIN32 AND TARGET FineObj AND TARGET FineObjStaticPart AND TARGET PortLayer)
    ...
    target_compile_definitions(FineObjects INTERFACE FINEAI_USE_FINEOBJ)
    ...
    if(MSVC)
        ...
        if(FineObj_FOUND)
            ...
            target_compile_definitions(FineObjects INTERFACE FINEAI_USE_FINEOBJ _UNICODE UNICODE)
        endif()
    elseif(XCODE AND IOS)
        ...
        if(FineObj_FOUND)
            ...
            target_compile_definitions(FineObjects INTERFACE FINEAI_USE_FINEOBJ _DLL _UNICODE UNICODE _NATIVE_WCHAR_T_DEFINED _MT __LITTLE_ENDIAN__ _PLATFORM_64_BIT)
        endif()
    else()
	    ...
	    target_compile_definitions(FineObjects INTERFACE _LINUX FINEAI_USE_FINEOBJ _DLL _UNICODE UNICODE _NATIVE_WCHAR_T_DEFINED _MT __LITTLE_ENDIAN__)
            if(NOT 32_BIT)
